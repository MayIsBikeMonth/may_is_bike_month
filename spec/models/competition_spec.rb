...
RSpec.describe Competition, type: :model do
  ...
  describe "competition_activities" do
    ...
    it "has matching activities" do
      expect(competition.reload.competition_activities_included.pluck(:id)).to match_array([competition_activity1.id])
      competition_user_excluded = FactoryBot.create(:competition_user, included_in_competition: false, competition:)
      expect(competition.competition_users.pluck(:id)).to match_array([competition_user.id, competition_user_excluded.id])
      expect(competition.competition_users_included.pluck(:id)).to match_array([competition_user.id])
    ...
    context "2023" do
      ...
      let(:target_periods) do
        [
          ...
          {start_date: "2023-05-08", end_date: "2023-05-14"},
          {start_date: "2023-05-15", end_date: "2023-05-21"},
          {start_date: "2023-05-22", end_date: "2023-05-28"},
          {start_date: "2023-05-29", end_date: "2023-05-31"}
        ]
      end
      it "returns the target" do
        expect(competition.periods).to eq target_periods
    ...
    context "2022" do
      ...
      let(:target_periods) do
        [
          ...
          {start_date: "2022-05-02", end_date: "2022-05-08"},
          {start_date: "2022-05-09", end_date: "2022-05-15"},
          {start_date: "2022-05-16", end_date: "2022-05-22"},
          {start_date: "2022-05-23", end_date: "2022-05-29"},
