ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "May Is Bike Month"
  ...
  config.authentication_method = :ensure_user_admin!
  ...
  #
  config.filter_attributes = [:encrypted_password, :password, :password_confirmation, :strava_auth]
